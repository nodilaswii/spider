...
//        log::$log_file = isset($configs['log_file']) ? $configs['log_file'] : PATH_DATA . '/phpspider.log';
        log::$log_file = isset($configs['log_file']) ? $configs['log_file'] : PATH_DATA . DIRECTORY_SEPARATOR . 'log' . DIRECTORY_SEPARATOR . $configs['name'] . '.log';
...
//        usleep(self::$configs['interval'] * 1000);
        isset(self::$configs['interval']) ? usleep(self::$configs['interval'] * 1000) : sleep(random_int(3, 50));
    }
